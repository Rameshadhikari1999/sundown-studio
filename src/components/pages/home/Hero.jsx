...
const Hero = () => {
  ...
  const golaRef = useRef();
  useGSAP(() => {
    let tl = gsap.timeline({ repeat: -1, yoyo: true });
    let tlCon = gsap.timeline({ repeat: -1 });
    tl.to(golaRef.current, {
      x: "80%",
      y: "-30%",
      duration: 5,
      ease: "power3.out",
  ...
  return (
    <div className="w-full relative px-4 pt-5">
      ...
      <div className="w-1/3 h-1/3 bg-[#FE360B] absolute right-0 top-[58vh] lg:top-[78vh] rounded-s-full blur-lg ">
        <div ref={golaRef} className="absolute w-80 h-80 bg-[#FE360B] rounded-full blur-lg" id="gola"></div>
      ...
      <div
        id="scroll"
        className="w-full overflow-x-auto  whitespace-nowrap pt-10 "
      >
        {[...Array(3)].map((_, i) => (
